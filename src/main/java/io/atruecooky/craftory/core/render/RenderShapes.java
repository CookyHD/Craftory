...
public class RenderShapes {
	...
	public static void cube(
		...
		cube(faces, poseStack, bufferSource, renderType, packedLight, packedOverlay, size_x, size_y, size_z, uv, Color.WHITE);
	}
	...
	public static float tube(
		...
		return tube(poseStack, bufferSource, renderType, packedLight, packedOverlay, size, length, uv, Color.WHITE);
	}
	...
	public static float tube(
		...
		for (int i = 0; i < stpes; i++) {
			...
			cube(Faces.HORIZONTAL, poseStack, bufferSource, renderType, packedLight, packedOverlay, size, size, size, uv, color);
			poseStack.translate(0.0, -(width * i), 0.0);
		}
		...
		cube(Faces.HORIZONTAL, poseStack, bufferSource, renderType, packedLight, packedOverlay, size, size-reminder, size, last_uv, color);
		poseStack.translate(0.0, -y_offset, 0.0);
